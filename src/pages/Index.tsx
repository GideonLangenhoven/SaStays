...
function BlogCard({ title, intro, info, articleLink, stats, bgImage }) {
  return (
              ...
              <div className="bg-white dark:bg-card rounded-xl shadow-2xl max-w-2xl w-full p-8 relative animate-fade-in overflow-y-auto max-h-[90vh]">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    <h3 className="text-2xl font-bold text-primary mb-2">{selectedApartment.name}</h3>
                    <div className="flex items-center gap-4 mb-2">
                      <span className="text-lg font-bold text-primary">R{selectedApartment.price.toLocaleString('en-ZA')}</span>
                    ...
                    <div className="flex items-center gap-4 text-sm text-muted-foreground mb-2">
                      ...
                      <span>{selectedApartment.size} m²</span>
