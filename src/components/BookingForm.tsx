          ...
          {currentStep === 1 && (
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="p-8 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={cn(
                          "h-12 text-lg border-2 rounded-xl pl-12",
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <Label htmlFor="agreeTerms" className="text-sm text-gray-700 leading-relaxed">
                        I agree to the <span className="text-blue-600 underline cursor-pointer">Terms of Service</span> and <span className="text-blue-600 underline cursor-pointer">Cancellation Policy</span>
                      </Label>
                    </div>
                    {errors.agreeTerms && (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <Label htmlFor="agreePrivacy" className="text-sm text-gray-700 leading-relaxed">
                        I agree to the <span className="text-blue-600 underline cursor-pointer">Privacy Policy</span> and consent to data processing in accordance with POPIA
                      </Label>
                    </div>
                    {errors.agreePrivacy && (
                    ...
                    <div className="flex items-start gap-3">
                      <Checkbox
                        ...
                        className="mt-1"
                      />
                      <Label htmlFor="agreeRules" className="text-sm text-gray-700 leading-relaxed">
                        I agree to follow the <span className="text-blue-600 underline cursor-pointer">House Rules</span> and understand that violations may result in booking cancellation
                      </Label>
                    </div>
                    {errors.agreeRules && (
                      <p className="text-red-500 text-sm ml-6">{errors.agreeRules}</p>
                    )}
                  </div>
                </div>
                ...
                <Button
                  onClick={handleNext}
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-semibold py-4 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 text-lg"
                  size="lg"
                >
                  Continue to Review
            ...
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="p-8 space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-blue-900">
                        {formatDate(mockBookingData.dates.checkIn)} - {formatDate(mockBookingData.dates.checkOut)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-blue-700">Nights:</span>
                      <span className="font-medium text-blue-900">{mockBookingData.dates.nights}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-blue-700">Guests:</span>
                      <span className="font-medium text-blue-900">{mockBookingData.guests}</span>
                    </div>
                  </div>
          </div>
                ...
                <Button
                  ...
                  <Button 
                    onClick={handleNext}
                    className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold py-3 rounded-xl shadow-lg transition-all duration-300"
                  >
                    Proceed to Payment
                    <ChevronRight className="ml-2 h-5 w-5" />
                  </Button>
              ...
              <CardContent className="p-8 space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {[
                      { name: 'PayFast', logo: '💳', desc: 'Card Payment' },
                      { name: 'Ozow', logo: '🏦', desc: 'Instant EFT' },
                      { name: 'Zapper', logo: '📱', desc: 'QR Code' },
                      { name: 'SnapScan', logo: '📲', desc: 'QR Code' }
                    ].map((method) => (
                      <button
                        key={method.name}
                        className="p-4 border-2 border-gray-200 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition-all duration-200 text-center"
                      >
                ...
                <Button 
                  ...
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-4 rounded-xl shadow-xl transition-all duration-300 transform hover:scale-105 text-lg"
                  size="lg"
                >
                  {loading ? (
                    ...
                    <>
                      ...
                      Pay {formatCurrency(mockBookingData.pricing.total)}
                    </>
                  )}
                </Button>
              ...
              <CardContent className="p-8 text-center space-y-6">
                ...
                <div className="bg-green-50 rounded-xl p-6 text-left">
                  ...
                  <ul className="space-y-2 text-sm text-green-700">
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4" />
                      Host will be notified immediately
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4" />
          ...
          <div className="sticky top-6 space-y-6">
            ...
            <Card className="shadow-lg border-0 overflow-hidden">
              <div className="relative h-48">
                <img 
                  src={mockBookingData.property.image} 
                  alt={mockBookingData.property.title}
                  className="w-full h-full object-cover"
                />
                <div className="absolute top-3 right-3">
                  <Badge className="bg-white/90 text-gray-800">
                    <Star className="h-3 w-3 mr-1 fill-yellow-400 text-yellow-400" />
                    {mockBookingData.property.rating}
                  </Badge>
          </div>
        </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 text-gray-600 mb-4">
                  ...
                  <span className="text-sm">{mockBookingData.property.location}</span>
          </div>
          
                {/* Host Info */}
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  <img 
                    src={mockBookingData.property.host.avatar}
                    alt={mockBookingData.property.host.name}
                    className="w-10 h-10 rounded-full"
                  />
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-sm">{mockBookingData.property.host.name}</span>
                      {mockBookingData.property.host.superhost && (
            ...
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  <span>{formatCurrency(mockBookingData.pricing.basePrice)} × {mockBookingData.dates.nights} nights</span>
                  <span>{formatCurrency(mockBookingData.pricing.subtotal)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Cleaning fee</span>
                  <span>{formatCurrency(mockBookingData.pricing.cleaningFee)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Service fee</span>
                  <span>{formatCurrency(mockBookingData.pricing.serviceFee)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Taxes</span>
                  <span>{formatCurrency(mockBookingData.pricing.taxes)}</span>
                </div>
                <Separator />
                <div className="flex justify-between font-bold text-lg">
                  <span>Total</span>
                  <span>{formatCurrency(mockBookingData.pricing.total)}</span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>Verified property photos</span>
                  </div>
                </div>
              </CardContent>
            </Card>
